...
export class RespirationComponent implements OnInit {
  ...
  datas2=[{"DeviceNumber":"00101","RespirationSignal":[5400],"ECGWaveform":[7984,8085,8180,8247,8307,8365,8413,8447,8482,8522],"ArrhythmiaAnnotation":[5],"Time":"2020-08-13 12:03:18.817","setSound":false},
    ...
    private initSvg() {
        ...
        this.svg = d3.select(".respiration")
            ...
            ;
        this.svg2 = d3.select(".respiration")
            .append('g')
            .attr('transform', 'translate(' + this.margin.left + ',' + this.margin.top+1 + ')')
            ;
    }
